		...
		<form method="post" action="sellerEditFarm" id="info_frm">
			...
			<div id="info_container">
				<div id="profile_box">
					...
					<div>방문 : ${result.farmvisitor}명 | 농장 즐겨찾기 : ${favorite}명</div>
				</div>
				<!-- profile_box 종료 -->
				<div id="farm_info">
					<div>INFO</div>
				...
				<div id="farm_contact">
					...
					<div id="contact_content">
						...
						<div>
							<span>상호명</span>
							<p name="storename">${result.storename }</p>
						</div>
						<div>
							<span>대표자</span>
							<p name="sellername">${result.sellername}</p>
						</div>
						<div>
							<span>사업자등록번호</span>
						...
						<div>
							<span>예금주</span>
							<p name="bankname">${result.bankname }</p>
						</div>
						<div>
							<span>은행명</span>
							<p name="bank">${result.bank }</p>
						</div>
						<div>
							<span>계좌번호</span>
							<p name="bankaccount">${result.bankaccount }</p>
						</div>
						<div>
							<span>E-Mail</span>
							<p name="storeemail">${result.storeemail }</p>
						</div>
					</div>
				</div>
				<!-- farm_contact 종료 -->
